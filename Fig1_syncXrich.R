...
mean_out <-readRDS(file = "output/richness_sync_300_0.8_0.6_0010_0.1_0_heteroP5.12July2019")
...
jpeg("figures/fig_1_phi_0.8.Rho_0.6.logFE_0.10.OU_0.hetP5.12July2019.jpeg",width=6, height=5.15, units="in",res=800)
