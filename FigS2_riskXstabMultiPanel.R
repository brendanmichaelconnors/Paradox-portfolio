########################################################################################
# FigS2_riskXstabMultiPanell.R
#
# Figure S2: Influence of management control, biodiversity and risk tolerance 
...
jpeg("figures/fig_S2.phi_0.8.Rho_0.6.logFE_0.1.OU_0.12July2019.jpeg",width=8, height=7, units="in",res=800)
