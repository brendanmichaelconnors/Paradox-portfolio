...
mean_out <-readRDS(file = "output/richness_sync_200_0.8_0.6_0010_0_0_heteroP2.15Feb2019")
...
jpeg("figures/fig_1_phi_0.8.Rho_0.6.logFE_0.15.OU_0.hetP2.Feb162019.jpeg",width=6, height=5.15, units="in",res=800)
...
mtext("Richness (no. populations)",1,line=-0.8,outer=T)
mtext("Synchrony",2,line=2.5)
