...
jpeg("figures/fig_S1_phi_0.8.Rho_0.6.logFE_0.1.OU_0.Jan152019.jpeg",width=6.5, height=3.25, units="in",res=800)
...
legend(1.9,50,c("0","0.125","0.25","0.5","0.75"),lwd=3,lty=1,col=c(colors[5],colors[4],colors[3],colors[2],colors[1]),cex=0.8, bty="n")
...
legend(1.9,50,c("1","0.88","0.75","0.5","0.25"),lwd=3,lty=1,col=c(colors[5],colors[4],colors[3],colors[2],colors[1]),cex=0.8, bty="n")
