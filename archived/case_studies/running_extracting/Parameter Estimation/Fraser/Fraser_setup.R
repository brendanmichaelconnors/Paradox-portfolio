##=============================================================================
## Reading in data to do parameter estimation for the Fraser River stocks
## May 14, 2018
##=============================================================================
...
# d <- d0.2[d0.2$CU!="Fennell",]
# d <- d[d$CU!="Harrison",]
# took out the two stocks for which there was no escapement estimates
# then took out the stocks where there are no priors, Harrison and Fennell
...
# Some of the matrices above are the same as those created in the previous for
# loop...not sure why we need both, but this seems largely to be legacy from 
# the original code that was shared with me
