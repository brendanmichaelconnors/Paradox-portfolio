########################################################################################
# FigS4_yieldXstabMultiPanell.R
#
# Figure S4: Influence of management control, biodiversity and risk tolerance 
...
jpeg("figures/fig_S4.phi_0.8.Rho_0.6.logFE_0.1.OU_0.11July2019.jpeg",width=8, height=7, units="in",res=800)
